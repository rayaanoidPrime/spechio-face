    ...
    <div className='flex flex-col w-full h-screen items-center justify-center z-10'>
      ...
      <div className='flex gap-1 self-start'>
        ...
        <div className='relative flex items-center'>
          <a className='z-10 mt-2 bg-gradient-to-tr from-prim to-sec rounded-3xl px-2 justify-self-center' href='./webcam'>
            <svg fill="#FFFFFF" width="17px" height="34px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='tooltip ml-2 whitespace-nowrap absolute left-full z-10 top-1/2 transform -translate-y-1/2  text-white font-bold text-sm px-2 py-1 w-auto rounded-xl pointer-events-none opacity-0 transition-opacity duration-200'>
